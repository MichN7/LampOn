...
public class VersionOld extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_version_old);
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!ban) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(VersionOld.this);
                    ...
                    pending_intent = PendingIntent.getBroadcast(VersionOld.this, 0, mi_intent, PendingIntent.FLAG_UPDATE_CURRENT);
                    ...
                    Intent main = new Intent(VersionOld.this, AlarmActivity.class)
